...
(custom-set-variables
 ...
 '(package-selected-packages
   '(helm-projectile flycheck-irony irony-eldoc ggtags helm projectile Projectile dumb-jump lsp-mode company-ctags doom-themes iedit expand-region flycheck dash rainbow-delimiters smartparens-config yasnippet which-key toc-org org-superstar org-modern counsel)))
(custom-set-faces
